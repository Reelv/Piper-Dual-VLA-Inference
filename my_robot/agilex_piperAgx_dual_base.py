...
from robot.controller.PiperAgx_controller import PiperAgxController
...
class PiperDual(Robot):
    def __init__(self, condition=condition, move_check=True, start_episode=0):
        ...
        self.controllers = {
            "arm":{
                "left_arm": PiperAgxController("left_arm"),
                "right_arm": PiperAgxController("right_arm"),
            }
        }
        self.sensors = {
            "image": {
    ...
    def set_up(self):
        super().set_up()
        self.controllers["arm"]["left_arm"].set_up("can0", teleop=False, arm_type="piper") # "piper_x"
        self.controllers["arm"]["right_arm"].set_up("can1", teleop=False, arm_type="piper") # "piper_x"
